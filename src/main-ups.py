...
OUTPUT_IMAGE_PATH = "./example/ups-output-image.png"
...
# Compute Grad-CAM (this part can be skipped for the current model)
...
player_generator = ImagePlayerIterator(image_tensor, list_indices=[], random=True, window_shape=(image_tensor.shape[0], 1, 1))
